...
- **Issues encountered**:
  - 1)technical and user experience challenges (slow performance), 2) usability limited (lack of visual guidance) 
- **Deviation from plan**:
...
- **Pending actions**:\
  None
- **Recommendations**:
  - Improvements in performance and usability (fit for purpose) are essential to the success of EUDI-wallets. - Recommendations for future pilots or replication: higher performance and UX-levels before starting testphase; planning testmaterials more timely. Changes proposed to methodology or components: improved survey end-users, based on industry standard questionnaires concerning UX.
